...
<head>
    ...
    <link href="<?php echo BASE_URL; ?>Assets/admin/src/assets/css/light/dashboard/dash_1.css" rel="stylesheet" type="text/css" />
    <link href="<?php echo BASE_URL; ?>Assets/admin/src/assets/css/dark/dashboard/dash_1.css" rel="stylesheet" type="text/css" />
    <!-- END PAGE LEVEL PLUGINS/CUSTOM STYLES -->

    <!-- BEGIN PAGE LEVEL STYLES -->
    <link rel="stylesheet" type="text/css" href="<?php echo BASE_URL; ?>Assets/admin/src/plugins/src/table/datatable/datatables.css">

    <link rel="stylesheet" type="text/css" href="<?php echo BASE_URL; ?>Assets/admin/src/plugins/css/light/table/datatable/dt-global_style.css">
    <link rel="stylesheet" type="text/css" href="<?php echo BASE_URL; ?>Assets/admin/src/plugins/css/light/table/datatable/custom_dt_miscellaneous.css">
    <link rel="stylesheet" type="text/css" href="<?php echo BASE_URL; ?>Assets/admin/src/plugins/css/dark/table/datatable/dt-global_style.css">
            ...
            <ul class="navbar-item flex-row ms-lg-auto ms-0">
                ...
                <li class="nav-item dropdown language-dropdown">
                    <a href="javascript:void(0);" class="nav-link dropdown-toggle" id="language-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <img src="<?php echo BASE_URL; ?>Assets/admin/src/assets/img/1x1/us.svg" class="flag-width" alt="flag">
                    </a>
                    <div class="dropdown-menu position-absolute" aria-labelledby="language-dropdown">
                        <a class="dropdown-item d-flex" href="javascript:void(0);"><img src="<?php echo BASE_URL; ?>Assets/admin/src/assets/img/1x1/us.svg" class="flag-width" alt="flag"> <span class="align-self-center">&nbsp;USA</span></a>
                        <a class="dropdown-item d-flex" href="javascript:void(0);"><img src="<?php echo BASE_URL; ?>Assets/admin/src/assets/img/1x1/tr.svg" class="flag-width" alt="flag"> <span class="align-self-center">&nbsp;Turkey</span></a>
                        <a class="dropdown-item d-flex" href="javascript:void(0);"><img src="<?php echo BASE_URL; ?>Assets/admin/src/assets/img/1x1/br.svg" class="flag-width" alt="flag"> <span class="align-self-center">&nbsp;Brazil</span></a>
                        <a class="dropdown-item d-flex" href="javascript:void(0);"><img src="<?php echo BASE_URL; ?>Assets/admin/src/assets/img/1x1/in.svg" class="flag-width" alt="flag"> <span class="align-self-center">&nbsp;India</span></a>
                        <a class="dropdown-item d-flex" href="javascript:void(0);"><img src="<?php echo BASE_URL; ?>Assets/admin/src/assets/img/1x1/de.svg" class="flag-width" alt="flag"> <span class="align-self-center">&nbsp;Germany</span></a>
                    </div>
                </li>
                        ...
                        <div class="notification-scroll">
                            <div class="dropdown-item">
                                <div class="media server-log">
                                    <img src="<?php echo BASE_URL; ?>Assets/admin/src/assets/img/profile-16.jpeg" class="img-fluid me-2" alt="avatar">
                            ...
                            <div class="dropdown-item">
                                <div class="media ">
                                    <img src="<?php echo BASE_URL; ?>Assets/admin/src/assets/img/profile-15.jpeg" class="img-fluid me-2" alt="avatar">
                                    <div class="media-body">
                                        <div class="data-info">
                            ...
                            <div class="dropdown-item">
                                <div class="media file-upload">
                                    <img src="<?php echo BASE_URL; ?>Assets/admin/src/assets/img/profile-21.jpeg" class="img-fluid me-2" alt="avatar">
                                    <div class="media-body">
                                        <div class="data-info">
                    ...
                    <a href="javascript:void(0);" class="nav-link dropdown-toggle user" id="userProfileDropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <div class="avatar-container">
                            <div class="avatar avatar-sm avatar-indicators avatar-online">
                                <img alt="avatar" src="<?php echo BASE_URL; ?>Assets/admin/src/assets/img/profile-30.png" class="rounded-circle">
                            </div>
                        </div>
                    </a>
        ...
        <div class="sidebar-wrapper sidebar-theme">
            ...
            <nav id="sidebar">
                ...
                <div class="navbar-nav theme-brand flex-row  text-center">
                    <div class="nav-logo">
                        <div class="nav-item theme-logo">
                            <a href="./index.html">
                                <img src="<?php echo BASE_URL; ?>Assets/admin/src/assets/img/logo.svg" class="" alt="logo">
                                <!-- <img src="<//?php echo BASE_URL; ?>Assets/admin/src/assets/img/logo.svg" class="navbar-logo" alt="logo"> -->
                            </a>
                        </div>
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    ...
                    <li class="menu">
                        <a href="<?php echo BASE_URL . 'usuarios'; ?>" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                    ...
                    <li class="menu">
                        <a href="<?php echo BASE_URL . 'categorias'; ?>" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
