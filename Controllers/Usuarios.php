...
class Usuarios extends Controller
{
    ...
    public function listar()
    {
        ...
        for ($i = 0; $i < count($data); $i++) {
            $data[$i]['accion'] = '
            <div class="d-flex">
                <button class="btn btn-outline-info mb-2 me-4 btn-rounded btn-icon" onclick="editUser(' . $data[$i]['id'] . ')">
                ...
                if (empty($id)) {
                    if ($_POST['contrasena'] != $_POST['confirmarcontrasena']) {
                        ...
                        if (empty($result)) {
                            ...
                            if ($data > 0) {
                                $respuesta = array('msg' => 'usuario registrado con éxito', 'icono' => 'success');
                            } else {
                    ...
                    if (empty($result)) {
                        ...
                        if ($data == 1) {
                            $respuesta = array('msg' => 'usuario modificado con éxito', 'icono' => 'success');
                        } else {
